...
function LogoMark({ size = 40, shape = "squircle", tone = "onLight", color, tileColor, markSrc = DEFAULT_MARK, style, ...rest }) {
  ...
  return /* @__PURE__ */ jsx(
    "span",
    {
      ...
      ...rest,
      children: /* @__PURE__ */ jsx("img", { src: markSrc, alt: "", style: { width: size * 0.62, height: size * 0.62, display: "block", objectFit: "contain" } })
    }
  );
}
...
function Tagline({ size, tone, color, rules }) {
  const t = tones(tone, color);
  const line = /* @__PURE__ */ jsx("span", { style: { height: 1, width: size * 0.9, background: t.rule, flex: "0 0 auto" } });
  return /* @__PURE__ */ jsxs("span", { style: { display: "inline-flex", alignItems: "center", gap: size * 0.45, color: t.sub, fontFamily: "var(--font-sans)", fontWeight: "var(--weight-medium)", fontSize: size, lineHeight: 1.2, letterSpacing: "0.01em", whiteSpace: "nowrap" }, children: [
    rules ? line : null,
    TAGLINE,
    rules ? line : null
  ] });
...
function Logo({
  ...
  if (tileColor) t.tile = tileColor;
  if (variant === "mark") return /* @__PURE__ */ jsx(LogoMark, { size, shape: shape || "squircle", tone, color, tileColor, markSrc, style, ...rest });
  if (variant === "wordmark") {
    return wrap(
      /* @__PURE__ */ jsxs("span", { style: { display: "inline-flex", flexDirection: "column", alignItems: "flex-start", gap: size * 0.16 }, children: [
        /* @__PURE__ */ jsx(LogoWordmark, { size: size * 0.72, tone, color }),
        tagline ? /* @__PURE__ */ jsx(Tagline, { size: size * 0.2, tone, color }) : null
      ] }),
      { alignItems: "center" }
    );
  }
  if (variant === "stacked") {
    return wrap(
      /* @__PURE__ */ jsxs("span", { style: { display: "inline-flex", flexDirection: "column", alignItems: "center", gap: size * 0.28 }, children: [
        /* @__PURE__ */ jsx(LogoMark, { size, shape: shape || "squircle", tone, color, tileColor, markSrc }),
        /* @__PURE__ */ jsx(LogoWordmark, { size: size * 0.62, tone, color }),
        tagline ? /* @__PURE__ */ jsx(Tagline, { size: size * 0.17, tone, color }) : null
      ] }),
    ...
    return wrap(
      /* @__PURE__ */ jsxs(
        "span",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("img", { src: markSrc, alt: "", style: { width: size * 0.56, height: size * 0.56, display: "block", objectFit: "contain" } }),
            /* @__PURE__ */ jsx(LogoWordmark, { size: size * 0.52, tone: "mono", color: tone === "mono" ? "var(--bledi-neutral-000)" : "var(--bledi-gold-400)" })
          ]
        }
      ),
      { alignItems: "center" }
    ...
    return wrap(
      /* @__PURE__ */ jsxs(
        "span",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("img", { src: markSrc, alt: "", style: { width: size * 0.42, height: size * 0.42, display: "block", objectFit: "contain" } }),
            /* @__PURE__ */ jsx(LogoWordmark, { size: size * 0.2, tone: "mono", color: "var(--bledi-gold-400)" }),
            tagline ? /* @__PURE__ */ jsx(Tagline, { size: size * 0.052, color: "rgba(255,255,255,.86)", tone: "mono", rules: true }) : null
          ]
        }
      ),
      { alignItems: "center" }
  ...
  return wrap(
    /* @__PURE__ */ jsxs("span", { style: { display: "inline-flex", alignItems: "center", gap: size * 0.28 }, children: [
      /* @__PURE__ */ jsx(LogoMark, { size, shape: shape || "squircle", tone, color, tileColor, markSrc }),
      /* @__PURE__ */ jsxs("span", { style: { display: "inline-flex", flexDirection: "column", alignItems: "flex-start", gap: size * 0.08 }, children: [
        /* @__PURE__ */ jsx(LogoWordmark, { size: size * 0.58, tone, color }),
        tagline ? /* @__PURE__ */ jsx(Tagline, { size: size * 0.17, tone, color }) : null
      ] })
    ] }),
    { alignItems: "center" }
...
function Alert({ tone = "notice", icon, style, children, ...rest }) {
  ...
  return /* @__PURE__ */ jsxs2(
    "div",
    {
      ...
      ...rest,
      children: [
        icon ? /* @__PURE__ */ jsx2("span", { style: { color: t.icon, display: "inline-flex", flex: "0 0 auto", marginTop: "1px" }, children: icon }) : null,
...
function Chip({ icon, selected = false, forbidden = false, style, children, ...rest }) {
  return /* @__PURE__ */ jsxs5(
    "span",
    {
      ...
      ...rest,
      children: [
        icon ? /* @__PURE__ */ jsx5("span", { style: { color: forbidden ? "var(--text-danger)" : "var(--text-brand)", display: "inline-flex" }, children: icon }) : null,
        children
      ]
    }
  );
  ...
  return /* @__PURE__ */ jsxs6(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx6("div", { style: { fontSize: "var(--text-md)", fontWeight: "var(--weight-semibold)", color: "var(--text-primary)" }, children: title }),
        description ? /* @__PURE__ */ jsx6("div", { style: { fontSize: "var(--text-sm)", color: "var(--text-secondary)", marginTop: "4px" }, children: description }) : null,
        action ? /* @__PURE__ */ jsx6("div", { style: { marginTop: "var(--space-5)" }, children: action }) : null
      ]
    }
  );
}
...
function Icon({ name, size = 18, strokeWidth = 2, fill = "none", style, ...rest }) {
  ...
  return /* @__PURE__ */ jsx7(
    "svg",
    {
      ...
      "aria-hidden": "true",
      ...rest,
      children: d.map((p, i) => /* @__PURE__ */ jsx7("path", { d: p }, i))
    }
  );
}
...
function RatingStars({ value = 0, count, size = 14, editable = false, onChange, style, ...rest }) {
  return /* @__PURE__ */ jsxs7("span", { style: { display: "inline-flex", alignItems: "center", gap: 4, fontFamily: "var(--font-sans)", ...style }, ...rest, children: [
    [1, 2, 3, 4, 5].map((n) => {
      ...
      return /* @__PURE__ */ jsx8(
        "span",
        {
          ...
          children: /* @__PURE__ */ jsx8(Icon, { name: "star", size, fill: on ? "currentColor" : "none" })
        },
        n
      );
    }),
    /* @__PURE__ */ jsx8("span", { style: { fontSize: "var(--text-sm)", color: "var(--text-primary)", marginLeft: 4 }, children: value.toFixed(1) }),
    count != null ? /* @__PURE__ */ jsxs7("span", { style: { fontSize: "var(--text-xs)", color: "var(--text-secondary)" }, children: [
      "\xB7 ",
      count,
      " avis"
    ] }) : null
...
function VerifiedName({ name, verified = false, size = "var(--text-base)", markSize = 18, tone = "brand", markSrc, style, ...rest }) {
  return /* @__PURE__ */ jsxs8("span", { style: { display: "inline-flex", alignItems: "center", gap: 6, fontFamily: "var(--font-sans)", fontSize: size, fontWeight: "var(--weight-medium)", ...style }, ...rest, children: [
    name,
    verified ? /* @__PURE__ */ jsx9(VerifiedMark, { size: markSize, tone, src: markSrc }) : null
  ] });
}
...
function OfficialTripCard({ carrier, reference, route, date, times, selected = false, onSelect, style, ...rest }) {
  return /* @__PURE__ */ jsxs9(
    "button",
    {
      ...
      ...rest,
      children: [
        /* @__PURE__ */ jsxs9("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "var(--space-4)" }, children: [
          /* @__PURE__ */ jsxs9("span", { style: { fontSize: "var(--text-base)", fontWeight: "var(--weight-semibold)", color: "var(--text-brand)" }, children: [
            carrier,
            " \xB7 ",
            reference
          ] }),
          /* @__PURE__ */ jsx10(Badge, { tone: "verified", icon: /* @__PURE__ */ jsx10(Icon, { name: "shield-check", size: 12 }), children: "V\xE9rifi\xE9" })
        ] }),
        /* @__PURE__ */ jsx10("div", { style: { fontSize: "var(--text-sm)", marginTop: 4 }, children: route }),
        /* @__PURE__ */ jsxs9("div", { style: { display: "flex", alignItems: "center", gap: 8, fontSize: "var(--text-sm)", color: "var(--text-secondary)", marginTop: 6 }, children: [
          /* @__PURE__ */ jsx10(Icon, { name: "calendar", size: 13 }),
          date
        ] }),
        /* @__PURE__ */ jsxs9("div", { style: { display: "flex", alignItems: "center", gap: 8, fontSize: "var(--text-sm)", color: "var(--text-secondary)", marginTop: 4 }, children: [
          /* @__PURE__ */ jsx10(Icon, { name: "clock", size: 13 }),
          times
        ] }),
        selected ? /* @__PURE__ */ jsxs9("div", { style: { display: "flex", alignItems: "center", gap: 6, marginTop: 10, fontSize: "var(--text-sm)", fontWeight: "var(--weight-medium)", color: "var(--text-brand)" }, children: [
          /* @__PURE__ */ jsx10(Icon, { name: "check", size: 14 }),
      ...
      children: [
        ...
        linkLabel ? /* @__PURE__ */ jsxs10(
          "button",
          {
            ...
            children: [
              linkLabel,
              /* @__PURE__ */ jsx11(Icon, { name: "arrow-right", size: 16 })
            ]
          }
        ) : null
      ]
...
function TripBanner({ eyebrow = "Trajet officiel", title, route, schedule, style, ...rest }) {
  return /* @__PURE__ */ jsxs13(
    "div",
    {
      ...
      ...rest,
      children: [
        /* @__PURE__ */ jsx14("div", { style: { fontSize: "var(--text-2xs)", letterSpacing: "var(--tracking-caps)", textTransform: "uppercase", color: "var(--text-accent)", fontWeight: "var(--weight-semibold)" }, children: eyebrow }),
        /* @__PURE__ */ jsx14("div", { style: { fontSize: "var(--text-md)", fontWeight: "var(--weight-semibold)", marginTop: 8 }, children: title }),
        /* @__PURE__ */ jsx14("div", { style: { fontSize: "var(--text-sm)", color: "var(--text-on-dark-muted)", marginTop: 4 }, children: route }),
        /* @__PURE__ */ jsx14("div", { style: { fontSize: "var(--text-sm)", color: "var(--text-on-dark-muted)", marginTop: 2 }, children: schedule })
      ]
    }
  );
}
...
function VerificationRow({ icon, title, description, status = "OK", done = true, style, ...rest }) {
  return /* @__PURE__ */ jsxs14(
    "div",
    {
      ...
      ...rest,
      children: [
        /* @__PURE__ */ jsx15("span", { style: { width: 34, height: 34, flex: "0 0 auto", borderRadius: "var(--radius-md)", background: "var(--surface-muted)", color: "var(--text-brand)", display: "inline-flex", alignItems: "center", justifyContent: "center" }, children: icon }),
        /* @__PURE__ */ jsxs14("div", { style: { flex: 1, minWidth: 0 }, children: [
          /* @__PURE__ */ jsx15("div", { style: { fontSize: "var(--text-base)", fontWeight: "var(--weight-medium)" }, children: title }),
          /* @__PURE__ */ jsx15("div", { style: { fontSize: "var(--text-xs)", color: "var(--text-secondary)", marginTop: 2 }, children: description })
        ] }),
        /* @__PURE__ */ jsxs14("span", { style: { display: "inline-flex", alignItems: "center", gap: 6, fontSize: "var(--text-sm)", color: done ? "var(--text-brand)" : "var(--text-secondary)" }, children: [
          done ? /* @__PURE__ */ jsx15(Icon, { name: "check", size: 15 }) : null,
          status
        ] })
      ]
    }
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs15(
        "div",
        {
          ...
          ...rest,
          children: [
            /* @__PURE__ */ jsxs15("div", { style: { display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: "var(--space-4)" }, children: [
              /* @__PURE__ */ jsx16("h2", { style: { margin: 0, fontSize: "var(--text-lg)", fontWeight: "var(--weight-semibold)" }, children: title }),
              /* @__PURE__ */ jsx16(
                "button",
                {
                  type: "button",
                  ...
                  children: /* @__PURE__ */ jsx16(Icon, { name: "x", size: 15 })
                }
              )
            ] }),
            description ? /* @__PURE__ */ jsx16("p", { style: { margin: "var(--space-3) 0 0", fontSize: "var(--text-base)", color: "var(--text-secondary)", lineHeight: "var(--leading-relaxed)" }, children: description }) : null,
            children ? /* @__PURE__ */ jsx16("div", { style: { marginTop: "var(--space-5)" }, children }) : null,
            actions ? /* @__PURE__ */ jsx16("div", { style: { display: "flex", gap: "var(--space-3)", justifyContent: "flex-end", marginTop: "var(--space-6)" }, children: actions }) : null
          ]
        }
      )
    }
...
function StatusTimeline({ steps = [], current = 0, style, ...rest }) {
  return /* @__PURE__ */ jsx17("ol", { style: { listStyle: "none", margin: 0, padding: 0, fontFamily: "var(--font-sans)", ...style }, ...rest, children: steps.map((s, i) => {
    const done = i < current;
    const active = i === current;
    const last = i === steps.length - 1;
    return /* @__PURE__ */ jsxs16("li", { style: { display: "flex", gap: "var(--space-4)" }, children: [
      /* @__PURE__ */ jsxs16("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", flex: "0 0 auto" }, children: [
        /* @__PURE__ */ jsx17("span", { style: {
          ...
          fontSize: "var(--text-xs)",
          fontWeight: "var(--weight-semibold)"
        }, children: done ? /* @__PURE__ */ jsx17(Icon, { name: "check", size: 13, strokeWidth: 2.6 }) : i + 1 }),
        !last ? /* @__PURE__ */ jsx17("span", { style: { width: 2, flex: 1, minHeight: 26, background: done ? "var(--bledi-green-700)" : "var(--bledi-neutral-200)" } }) : null
      ] }),
      /* @__PURE__ */ jsxs16("div", { style: { paddingBottom: last ? 0 : "var(--space-5)" }, children: [
        /* @__PURE__ */ jsx17("div", { style: { fontSize: "var(--text-base)", fontWeight: active ? "var(--weight-semibold)" : "var(--weight-regular)", color: done || active ? "var(--text-primary)" : "var(--text-secondary)" }, children: s.label }),
        s.detail ? /* @__PURE__ */ jsx17("div", { style: { fontSize: "var(--text-sm)", color: "var(--text-secondary)", marginTop: 2 }, children: s.detail }) : null
      ] })
    ] }, s.label);
  }) });
}
...
function Toast({ tone = "success", children, onClose, style, ...rest }) {
  ...
  return /* @__PURE__ */ jsxs17(
    "div",
    {
      ...
      ...rest,
      children: [
        /* @__PURE__ */ jsx18("span", { style: { color: success ? "var(--text-accent)" : "#FFFFFF", display: "inline-flex" }, children: /* @__PURE__ */ jsx18(Icon, { name: success ? "check" : "alert", size: 16 }) }),
        children,
        onClose ? /* @__PURE__ */ jsx18("button", { type: "button", onClick: onClose, style: { background: "transparent", border: "none", color: "inherit", opacity: 0.6, cursor: "pointer", padding: 0, display: "inline-flex" }, children: /* @__PURE__ */ jsx18(Icon, { name: "x", size: 14 }) }) : null
      ]
    }
  );
}
...
function Checkbox({ checked = false, onChange, label, hint, style, ...rest }) {
  return /* @__PURE__ */ jsxs18(
    "label",
    {
      ...
      ...rest,
      children: [
        /* @__PURE__ */ jsx19("input", { type: "checkbox", checked, onChange: (e) => onChange && onChange(e.target.checked), style: { position: "absolute", opacity: 0, width: 0, height: 0 } }),
        /* @__PURE__ */ jsx19("span", { style: {
          ...
          justifyContent: "center",
          transition: "var(--transition-default)"
        }, children: checked ? /* @__PURE__ */ jsx19(Icon, { name: "check", size: 14, strokeWidth: 2.6 }) : null }),
        /* @__PURE__ */ jsxs18("span", { children: [
          /* @__PURE__ */ jsx19("span", { style: { display: "block" }, children: label }),
          hint ? /* @__PURE__ */ jsx19("span", { style: { display: "block", fontSize: "var(--text-sm)", color: "var(--text-secondary)", marginTop: 2 }, children: hint }) : null
        ] })
      ]
    }
  );
...
function CodeInput({ length = 6, value = "", onChange, style, ...rest }) {
  ...
  return /* @__PURE__ */ jsx20("div", { style: { display: "flex", gap: "var(--space-2)", ...style }, ...rest, children: chars.map((c, i) => /* @__PURE__ */ jsx20(
    "input",
    {
      ref: (el) => {
        refs.current[i] = el;
...
function Input({ style, ...rest }) {
  return /* @__PURE__ */ jsx22("input", { style: { ...inputBase, minHeight: "var(--tap-target-min)", ...style }, ...rest });
}
function Textarea({ rows = 4, style, ...rest }) {
  return /* @__PURE__ */ jsx22("textarea", { rows, style: { ...inputBase, resize: "vertical", lineHeight: "var(--leading-normal)", ...style }, ...rest });
}

// src/components/forms/OptionToggle.tsx
import { jsx as jsx23, jsxs as jsxs20 } from "react/jsx-runtime";
function OptionToggle({ options = [], value, onChange, columns = 2, style, ...rest }) {
  return /* @__PURE__ */ jsx23("div", { style: { display: "grid", gridTemplateColumns: `repeat(${columns}, 1fr)`, gap: "var(--space-3)", ...style }, ...rest, children: options.map((o) => {
...
function PhotoUploader({ label = "Photos de l'objet", hint, count = 0, min = 2, onAdd, style, ...rest }) {
  ...
  return /* @__PURE__ */ jsxs21("div", { style: { fontFamily: "var(--font-sans)", ...style }, ...rest, children: [
    /* @__PURE__ */ jsx24("div", { style: { fontSize: "var(--text-sm)", color: "var(--text-secondary)", marginBottom: "var(--space-3)" }, children: label }),
    /* @__PURE__ */ jsx24("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(104px, 1fr))", gap: "var(--space-3)" }, children: slots.map((_, i) => {
      ...
      return /* @__PURE__ */ jsxs21(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsx24(Icon, { name: "camera", size: 18 }),
    ...
    hint ? /* @__PURE__ */ jsx24("div", { style: { fontSize: "var(--text-xs)", color: "var(--text-secondary)", marginTop: "var(--space-3)" }, children: hint }) : null
  ] });
}
...
function Select({ options = [], placeholder, style, ...rest }) {
  return /* @__PURE__ */ jsxs22("div", { style: { position: "relative", ...style }, children: [
    /* @__PURE__ */ jsxs22(
      "select",
      {
        style: {
        ...
        ...rest,
        children: [
          placeholder ? /* @__PURE__ */ jsx25("option", { value: "", children: placeholder }) : null,
          options.map((o) => /* @__PURE__ */ jsx25("option", { value: o, children: o }, o))
        ]
      }
    ),
    /* @__PURE__ */ jsx25("span", { style: { position: "absolute", right: 12, top: "50%", transform: "translateY(-50%)", color: "var(--text-secondary)", pointerEvents: "none", fontSize: 11, lineHeight: 1 }, children: "\u25B2\u25BC" })
  ] });
}
...
function Switch({ checked = false, onChange, label, hint, style, ...rest }) {
  return /* @__PURE__ */ jsxs23(
    "label",
    {
      ...
      ...rest,
      children: [
        /* @__PURE__ */ jsxs23("span", { style: { flex: 1, minWidth: 0 }, children: [
          /* @__PURE__ */ jsx26("span", { style: { display: "block" }, children: label }),
          hint ? /* @__PURE__ */ jsx26("span", { style: { display: "block", fontSize: "var(--text-sm)", color: "var(--text-secondary)", marginTop: 2 }, children: hint }) : null
        ] }),
        /* @__PURE__ */ jsx26("input", { type: "checkbox", checked, onChange: (e) => onChange && onChange(e.target.checked), style: { position: "absolute", opacity: 0, width: 0, height: 0 } }),
        ...
        }, children: /* @__PURE__ */ jsx26("span", { style: { width: 22, height: 22, borderRadius: "var(--radius-pill)", background: "#FFFFFF", boxShadow: "var(--shadow-card)" } }) })
      ]
    }
  );
}
      ...
      children: items.map((it) => {
        ...
        if (it.primary) {
          return /* @__PURE__ */ jsxs24(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsx27("span", { style: { width: 46, height: 46, borderRadius: "var(--radius-pill)", background: "var(--bledi-green-700)", color: "#FFF", display: "inline-flex", alignItems: "center", justifyContent: "center" }, children: /* @__PURE__ */ jsx27(Icon, { name: it.icon, size: 22 }) }),
                /* @__PURE__ */ jsx27("span", { style: { fontSize: "var(--text-2xs)", color: "var(--text-secondary)" }, children: it.label })
              ]
            },
            it.value
          );
        ...
        return /* @__PURE__ */ jsxs24(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx27(Icon, { name: it.icon, size: 20 }),
              /* @__PURE__ */ jsx27("span", { style: { fontSize: "var(--text-2xs)", fontWeight: on ? "var(--weight-medium)" : "var(--weight-regular)" }, children: it.label })
            ]
          },
          it.value
        );
...
function StepProgress({ step = 1, total = 5, label, stepLabel, style, ...rest }) {
  ...
  return /* @__PURE__ */ jsxs25("div", { style: { fontFamily: "var(--font-sans)", ...style }, ...rest, children: [
    /* @__PURE__ */ jsxs25("div", { style: { display: "flex", justifyContent: "space-between", fontSize: "var(--text-sm)", color: "var(--text-secondary)", marginBottom: "8px" }, children: [
      /* @__PURE__ */ jsx29("span", { children: stepLabel || `\xC9tape ${step} sur ${total}` }),
      /* @__PURE__ */ jsx29("span", { children: label })
    ] }),
    /* @__PURE__ */ jsx29("div", { style: { height: 4, borderRadius: "var(--radius-pill)", background: "var(--surface-muted)", overflow: "hidden" }, children: /* @__PURE__ */ jsx29("div", { style: { width: `${pct}%`, height: "100%", background: "var(--bledi-green-700)", borderRadius: "var(--radius-pill)", transition: "width var(--duration-slow) var(--ease-standard)" } }) })
  ] });
}
...
function TopNav({
  ...
  const marque = logoSrc ? /* @__PURE__ */ jsx30("img", { src: logoSrc, alt: logoLabel, style: { width: 44, height: 44, borderRadius: "var(--radius-pill)", display: "block" } }) : /* @__PURE__ */ jsx30("span", { style: { fontWeight: "var(--weight-bold)", color: "var(--text-brand)", fontSize: "var(--text-lg)" }, children: logoLabel });
  ...
  return /* @__PURE__ */ jsxs26(
    "header",
    {
      ...
      ...rest,
      children: [
        logoHref ? /* @__PURE__ */ jsx30("a", { href: logoHref, "aria-label": logoLabel, style: { ...styleMarque, textDecoration: "none" }, children: marque }) : onLogo ? /* @__PURE__ */ jsx30("button", { type: "button", onClick: onLogo, "aria-label": logoLabel, style: styleMarque, children: marque }) : /* @__PURE__ */ jsx30("span", { style: { display: "flex", alignItems: "center" }, children: marque }),
        /* @__PURE__ */ jsx30("nav", { style: { display: "flex", alignItems: "center", gap: "var(--space-2)" }, children: items.map((it) => {
          const on = it.value === active;
          return /* @__PURE__ */ jsxs26(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsx30(Icon, { name: it.icon, size: 16 }),
                it.label
              ]
            },
            it.value
        ...
        /* @__PURE__ */ jsxs26("div", { style: { display: "flex", alignItems: "center", gap: "var(--space-2)" }, children: [
          bell,
          actions
        ] })
      ]
...
function UnderlineTabs({ tabs = [], value, onChange, style, ...rest }) {
  return /* @__PURE__ */ jsx31("div", { style: { display: "grid", gridTemplateColumns: `repeat(${tabs.length}, 1fr)`, borderBottom: "1px solid var(--border-default)", ...style }, ...rest, children: tabs.map((t) => {
    const active = t.value === value;
