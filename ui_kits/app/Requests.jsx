...
export function Requests({ NS }) {
  const { Button, Badge, Icon, SegmentedTabs, RequestCard, EmptyState, Alert, ProtectionPanel } = NS;
      ...
      {tab === 'all' ? (
        <>
          ...
          <RequestCard
            ...
            date="25 août 2026"
            author="Yacine T." authorVerified markSrc="../../assets/bledi-b-mark.png" budget="90 €"
          ...
          <RequestCard
            ...
            date="12 août 2026"
            author="Sofia B." authorVerified markSrc="../../assets/bledi-b-mark.png" budget="25 €"
