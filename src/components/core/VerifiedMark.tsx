...
export function VerifiedMark({ size = 18, tone = 'brand', src = DEFAULT_SRC, title = 'Profil vérifié par Bledi', style, ...rest }: VerifiedMarkProps) {
...
export function VerifiedName({ name, verified = false, size = 'var(--text-base)', markSize = 18, tone = 'brand', markSrc, style, ...rest }: VerifiedNameProps) {
  return (
