import { Icon, IconName, Alert, VerificationRow } from '../../src/components';

export interface VerificationScreenProps { onBack?: () => void }

export function Verification({ onBack }: VerificationScreenProps = {}) {
