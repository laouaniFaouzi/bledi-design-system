...
import { Button, Badge, Icon, Avatar, Card, Alert, Switch, RatingStars, VerifiedMark, Chip } from '../../src/components';
import bMarkUrl from '../../assets/bledi-b-mark.png';

export interface ProfileScreenProps { onVerify?: () => void }

export function Profile({ onVerify }: ProfileScreenProps = {}) {
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-4)' }}>
          ...
          <div style={{ minWidth: 0 }}>
            <span style={{ display: 'inline-flex', alignItems: 'center', gap: 8, fontSize: 'var(--text-xl)', fontWeight: 'var(--weight-semibold)' }}>
              Karim B. <VerifiedMark size={22} tone="onDark" src={bMarkUrl} />
            </span>
