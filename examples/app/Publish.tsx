...
import { Button, Icon, Field, Select, Textarea, OptionToggle, StepProgress, OfficialTripCard, TripBanner, Alert } from '../../src/components';
...
export interface PublishScreenProps { onPublished?: () => void }

export function Publish({ onPublished }: PublishScreenProps = {}) {
  ...
  const labels: Record<number, string> = { 1: 'Type de demande', 2: 'Trajet officiel', 3: 'Détails', 4: 'Budget', 5: 'Sécurité & publier' };
  const banner = (
